            ...
            using (var trn = dbCtx.Database.BeginTransaction())
            {
                ...
                try
                {
                    ...
                    if (obj.SB_MASTER_VM.ID == Guid.Empty.ToString())
                    {
                        ...
                        sb_master.TRN_NO = trnLastNoListS.CreateTransactionNo(dbCtx, TransactionID.SB, obj.SB_MASTER_VM.SUB_SECTION_ID, dateTime);
                        ...
                        trnLastNoListS.UpdateTransactionNo(dbCtx, TransactionID.SB, obj.SB_MASTER_VM.SUB_SECTION_ID, dateTime);
